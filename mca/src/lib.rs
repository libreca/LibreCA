...
use common::{Number, ValueGenerator, UVec, u_vec};
use sut::Solver;
...
impl<ValueId: Number> MCA<ValueId> {
...
pub fn pc_to_mask<ParameterId: Number, const STRENGTH: usize>(
    pc: &[ParameterId; STRENGTH - 1],
    at_parameter: usize,
...
pub fn check_locations<ValueId: Number>(row: &[ValueId], locations: u64) -> bool {
    assert!(
